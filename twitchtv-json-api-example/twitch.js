function getTwitchData() {
  const offlineLogo = 'https://tylermoeller.github.io/fccfe/twitchtv-json-api-example/dead_glitch.png',
    users = [
      'ESL_SC2',
      'OgamingSC2',
      'cretetion',
...
function printData(userUrl, userStatus, userLogo, displayName, currentlyStreaming, userIcon) {
  ...
  $(`#${  userStatus}`).append(`<div id="${  displayName.toLowerCase()  }" class="users">` +
